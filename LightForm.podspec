...
Pod::Spec.new do |s|
  s.name             = 'LightForm'
  s.version          = '0.1.0'
  s.summary          = 'A short description of LightForm.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/LightForm'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Farshid Ghods' => 'farshid.ghods@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/LightForm.git', :tag => s.version.to_s }
